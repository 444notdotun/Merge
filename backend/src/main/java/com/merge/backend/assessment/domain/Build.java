...
public class Build {
     ...
     * All five AI-generated fields below are null until BUILD_PRD_GENERATION job completes.
    ...
    /**
     * Hidden test suite generated by AI-03 alongside the PRD.
     * Used exclusively for Gate 1 (JUDGE0) evaluation; NEVER returned in any API response.
     * The student's submitted test suite is evaluated separately in Gate 4 (TEST_QUALITY).
     */
    @Column(name = "hidden_test_suite", columnDefinition = "text")
